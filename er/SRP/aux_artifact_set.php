<!--
    Pagina que permite a criação e ou alteração dos artefatos(tabelas auxiliares)
...
<?php
    ...
    if ("update" == $mode)
    {
        $title = "Alterar Artefato" ;
        $url = "aux_artifact_update.php" ;
    ...
    {
        $title = "Cadastrar Artefato" ;
        $url = "aux_artifact_create.php" ;
        $artifactId = "";
        $name = "";
        $description = "";
    }
