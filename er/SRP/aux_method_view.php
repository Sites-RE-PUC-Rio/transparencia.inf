<!--
    Pagina que mostra uma visão do metodo(tabelas auxiliares)
-->
...
<body class="cinza12">
        <table width="700" border="0" align="left" cellpadding="4" cellspacing="0">
          ...
          <tr class="azul14">
            <td width="386" colspan="2"><strong>Método</strong></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
          </tr>
          ...
          <tr valign="top" class="cinza12">
            <td colspan="2"><a href="#" class="link"></a>
              <table width="100%" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td><div align="left"><strong>O que é</strong></div></td>
                  <td>&nbsp;</td>
                  <td><?php echo $what ?></td>
                </tr>
                <tr>
            ...
            <tr>
                  <td><div align="left"><strong>Restrição</strong></div></td>
                  <td>&nbsp;</td>
