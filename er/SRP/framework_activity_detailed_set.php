<!--
    Pagina que permite a criação e ou alteração das atividades detalhadas do framework
...
<?php
    ...
    if ("update" == $mode)
    {
        $url = "framework_activity_detailed_update.php" ;
        ...
        $caracteristics = $detailedActivity->getCaracteristics() ;
    }
    else if ("create" == $mode)
    {
        $url = "framework_activity_detailed_create.php" ;
...
<form method="POST" action="<?php echo $url ?>" onsubmit="return canSubmit('action', 'object', 'description')"/>
    ...
    <table width="700" border="0" align="left" cellpadding="4" cellspacing="0">
        ...
        <tr class="azul14">
            <td width="386" colspan="2"><strong>Atividade Detalhada</strong><div id="error" style="display:none" class="vermelho12"><br/>Preencha abaixo os campos o brigatórios marcados em vermelho.</div></td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
        </tr>
