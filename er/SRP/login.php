<!--
    Ação de logar p/ entrada  no sistema
-->
<?php
    ...
    if ( isset($_POST["submit"]) )
    {
        ...
        $user = DAOUser::getUser($login, $password) ;
        if (NULL != $user)
        {
            $_SESSION["user"] = $user ;
        }
            ...
            <td><div align="center">
                ...
                ?>
                      <table width="250" border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="#F7CACB" class="redtableborder">
                        <tr align="center" class="vermelho10">
                          <td>Login ou senha inválidos.</td>
                        </tr>
                      </table>
                <?php
                }
              ...
              <table width="250" border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="#F7FAFB" class="tableborder">
                ...
                <tr class="cinza10">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td><div align="left"><a href="signup.php" class="link">Novo usu&aacute;rio</a> </div></td>
                </tr>
                <tr class="cinza9">
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
