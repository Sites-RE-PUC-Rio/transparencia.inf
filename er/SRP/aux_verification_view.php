<!--
    Pagina que mostra uma visão da verificação(tabelas auxiliares)
-->
...
<body class="cinza12">
        <table width="700" border="0" align="left" cellpadding="4" cellspacing="0">
          ...
          <tr class="azul14">
            <td width="386" colspan="2"><strong>Verificação</strong></td>
          </tr>
          <tr>
            <td colspan="2">&nbsp;</td>
          </tr>
          ...
          <tr valign="top" class="cinza12">
            ...
            <tr>
                ...
                <tr>
                  ...
                  <td width="2%">&nbsp;</td>
                  <td width="69%"><?php echo $frequency ?></td>
                </tr>
                <tr>
                  <td><div align="left"></div></td>
                  <td>&nbsp;</td>
            ...
            <tr>
                  ...
                  <td width="2%">&nbsp;</td>
                  <td width="69%"><?php echo $worker ?></td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
