<!--
    Pagina que permite a criação e ou alteração da representação das atividades macro do processo
...
<?php
    ...
    $reference = Process::getMacroRepresentationRerence($processId) ;
    ...
    $next_page = "process_representation_detailed_set.php?processId=".$processId."&mode=".$mode ;
    if ("update" == $mode)
    {
            ...
            <tr valign="top" class="cinza12">
                <td colspan="2"><a href="#" class="link"></a>
                    <table width="100%" border="0" cellspacing="0" cellpadding="1">
                        <tr class="azul13">
                            <td colspan="3"><strong>Caracter&iacute;sticas das Atividades Macro</strong></td>
                        </tr>
