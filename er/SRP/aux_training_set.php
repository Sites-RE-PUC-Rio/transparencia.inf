<!--
    Pagina que permite a criação e ou alteração dos treinamentos(tabelas auxiliares)
...
<?php
    ...
    if ("update" == $mode)
    {
        ...
        $public = $training->getPublic() ;
    }
    else if ("create" == $mode)
    {
        $title = "Cadastrar Treinamento" ;
        $url = "aux_training_create.php" ;
        $trainingId = "";
        $name = "";
        $description = "";
        $public = "";
...
<body class="cinza12">
    ...
    <form method="POST" action="<?php echo $url?>" onsubmit="return canSubmit('name', 'description', 'public')">
          ...
          <tr valign="top" class="cinza12">
            <td colspan="2"><a href="#" class="link"></a>
              <table width="100%" border="0" cellspacing="0" cellpadding="1">
                ...
                <tr>
                  <td><div align="left"><strong>Publico</strong></div></td>
                  <td>&nbsp;</td>
                  <td><input id="public" name="public" type="text" class="input" size="16" value="<?php echo $public ?>"/></td>
                </tr>
                <tr>
