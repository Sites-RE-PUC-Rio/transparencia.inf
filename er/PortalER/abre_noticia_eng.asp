...
<table width="100%" border="0" height="27" background="fig25.GIF">
  <tr valign="top"> 
    <td height="31"> 
      <div align="left"> <font size="4"><font face="Verdana, Arial, Helvetica, sans-serif"><b>News 
        <font size="3"> </font></b></font></font></div>
    </td>
  </tr>
</table>
<br>
...
%> <br>
  ...
  <tr>
    <td><b><%= mid(RSnews.fields(3).value,3,2)&"/"&mid(RSnews.fields(3).value,1,2)&"/"&mid(RSnews.fields(3).value,5,4) %></b></td>
  </tr>
  <tr><td>&nbsp;</td></tr>
  <tr>
