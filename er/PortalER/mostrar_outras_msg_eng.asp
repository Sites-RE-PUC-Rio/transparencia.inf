...
<table width="100%" border="1" height="28" bordercolorlight="#CCCCCC">
  <tr bgcolor="#999999"> 
    ...
    <td height="15" width="43%"> 
      <div align="center"><font color="#FFFFFF"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Menssage</font></b></font></div>
    </td>
  </tr>
  <% contador = 0 %> 
...
<input type="hidden" name="inicial" value=<%=inicial%> >
   ...
   %>
    <input type="submit" name="Submit2" value="Last 10" onclick="return VoltaAnterior(this.form);">
    <%end if%>
    <%if not atual = 0  then%> 
    &nbsp;
