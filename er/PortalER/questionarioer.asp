...
function TestarBranco(form)
{
  ...
  if ((form.pergunta12[6].checked) && (outros == ""))
    { alert ("Por favor,escreva o nome da ferramenta ou técnica utilizada na pergunta 12.")
      form.outros.focus()
	  return false;}
...
<p>&nbsp;</p><form action="envia_questionario.asp" method="post">
  <table width="100%" border="0" align="center">
    ...
    <tr>
      <td colspan="5" height="26">1) <i>Como você acredita que o cliente percebe
        a entrega do sistema em relação as necessidades deles?</i> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5" height="11">
		...
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=1) Como você acredita que o cliente percebe a entrega do sistema em relação as necessidades deles?&numero=pergunta1&quant=5','pergunta1','status=yes,width=320,height=280')">Resultado Parcial</a></div>

      </td>
    </tr>
    <tr>
      <td colspan="5" height="25">2) <i>Como você acredita que os clientes percebem
    ...
    <tr>
	  ...
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=2) Como você acredita que os clientes percebem a importancia da fase de levantamento de requisitos?&numero=pergunta2&quant=5','pergunta2','status=yes,width=320,height=280')">Resultado Parcial</a></div>
    ...
    <tr>
	  ...
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=3) Os requisitos, quando precisam ser revistos ou consultados são: &numero=pergunta3&quant=5','pergunta3','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">4) <i>Como você classificaria os procedimentos de sua organização
    ...
    <tr>
      <td colspan="5">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=4) Como você classificaria os procedimentos de sua organização para identificar, coletar, armazenar, manter registros sobre controle de qualidade, com base nos requisitos, de forma que possam ser recuperados?&numero=pergunta4&quant=5','pergunta4','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">5) <i>De que maneira os requisitos do sistema são utilizados
        na sua organização como base para o desenvolvimento de software?</i> </td>
    </tr>
    <tr>
      <td colspan="5">
    ...
    <tr>
      <td colspan="5">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=5) De que maneira os requisitos do sistema são utilizados na sua organização como base para o desenvolvimento de software?&numero=pergunta5&quant=5','pergunta5','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">6) <i>Como você classifica o método utilizado na sua organização
        para o levantamento (elicitação) de requisitos?</i> </td>
    </tr>
    <tr>
      <td colspan="5">
    ...
    <tr>
      <td colspan="5">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=6) Como você classifica o método utilizado na sua organização para o levantamento (elicitação) de requisitos? &numero=pergunta6&quant=5','pergunta6','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">7) <i>Durante o uso de um sistema ou durante sua construção
        é verificada uma alteração nos requisitos. Essa alteração</i>: </td>
    </tr>
    <tr>
      <td colspan="5">
    ...
    <tr>
	  ...
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=7) Durante o uso de um sistema ou durante sua construção é verificada uma alteração nos requisitos. Essa alteração: &numero=pergunta7&quant=5','pergunta7','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5">9) <i>Quanto do tempo total de um projeto é normalmente
    ...
    <tr>
      <td colspan="5">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=9) Quanto do tempo total de um projeto é normalmente dedicado ao levantamento de requisitos? &numero=pergunta9&quant=5','pergunta9','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">10) <i>Como voce classifica o treinamento existente em engenharia
        de requisitos na sua organização?</i> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=10) Como voce classifica o treinamento existente em engenharia de requisitos na sua organização? &numero=pergunta10&quant=5','pergunta10','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">11) <i>Como voce classifica o uso de ferramentas para apoiar
        a definição de requisitos?</i> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5" height="11">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=11) Como voce classifica o uso de ferramentas para apoiar a definição de requisitos? &numero=pergunta11&quant=5','pergunta11','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">12) <i>Marque abaixo quais técnicas/ferramentas que são
        utilizadas em sua empresa no processo de definição de requisitos</i>:
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="5">&nbsp;
	  <div align="right"><a href="#"
		onClick="MM_openBrWindow('http://139.82.24.188:9090/per/servlet/Teste1?perg=12) Marque abaixo quais técnicas/ferramentas que são utilizadas em sua empresa no processo de definição de requisitos: &numero=pergunta12&quant=7','pergunta12','status=yes,width=320,height=280')">Resultado Parcial</a></div>
	  </td>
    </tr>
    <tr>
      <td colspan="5">13) <i>Coloque aqui suas observações sobre a engenharia
        de requisitos</i>: </td>
    </tr>
    <tr>
      <td colspan="5">
