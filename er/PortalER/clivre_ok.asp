...
<table width="100%" border="0" height="27" background="fig25.GIF">
  <tr valign="top"> 
    <td height="21"> 
      <div align="left"> <font size="4"><font face="Verdana, Arial, Helvetica, sans-serif"><b>Canal 
        Livre<font size="3"> </font></b></font></font></div>
    </td>
  </tr>
</table>
<%If NOT RS.EOF Then%> 
      
<form action="envio_msg.asp" method="post">
  <table width="97%" border="0" height="100">
    ...
    <tr> 
      <td width="32%" height="39" valign="top">
        ...
        <input type="reset" name="Reset2" value="Limpar">
      </td>
