...
<table width="100%" border="0" background="fig25.GIF">
  <tr>
    <td height="30"><font size="4"><font face="Verdana, Arial, Helvetica, sans-serif"><b>Altera&ccedil;&atilde;o 
      de senha<font size="3"></font></b></font></font></td>
  </tr>
</table><br><br>
<br>
<form action="alterasenha_ok.asp" method="post">
<table width="35%" border="0" align="center" background="fundotab.gif">
  ...
  <tr> 
    <td width="70%"><font face="Verdana, Arial, Helvetica, sans-serif">senha</font></td>
    <td width="30%"> 
      <div align="center"> 
  ...
  <tr> 
    <td width="70%"><font face="Verdana, Arial, Helvetica, sans-serif">nova senha</font></td>
    <td width="30%"> 
      <div align="center"> 
  ...
  <tr> 
    <td height="22" width="70%"><font face="Verdana, Arial, Helvetica, sans-serif">repita 
      nova senha</font></td>
