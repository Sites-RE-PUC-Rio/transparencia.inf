...
<!- Seleciona grupo para a exclusão -->
<body bgcolor="#FFFFFF">
<%
  Dim count 
...
<!- Envia formulário com o grupo selecionado para excluir_grupo_confirma.asp -->
<form action="excluir_grupo_confirma.asp" method="post">
  <table width="75%" border="0" align="center" height="117">
    <tr> 
    <td colspan="3"> 
        <div align="center"><b><font size="5">Gerenciador de grupos - (exclus&atilde;o 
          de grupo)</font></b></div>
    </td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td height="27" colspan="2">
	  ...
	  <%else%> <!- Caso não exista nenhum grupo criado -->
